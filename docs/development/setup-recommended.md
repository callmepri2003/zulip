...
1. Install [Vagrant][vagrant-dl] (latest version).
2. Install [Docker Desktop](https://docs.docker.com/desktop/mac/install/) (latest version).
3. Open Docker Desktop and configure the file sharing settings:
